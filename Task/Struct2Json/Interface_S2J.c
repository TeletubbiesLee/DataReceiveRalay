...
cJSON *ConfigFile_StructToJson(void* struct_obj)
{
	...
	s2j_json_set_basic_element(json_obj, struct_Config, string, name);		//名称
	s2j_json_set_basic_element(json_obj, struct_Config, int, parameter);	//参数
...
ConfigFile *ConfigFile_JsonToStruct(cJSON* json_obj)
{
    ...
    s2j_struct_get_basic_element(struct_Config, json_obj, int, parameter);	//参数
